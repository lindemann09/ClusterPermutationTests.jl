struct ClusterPermutationTestDefinition
    # estim
    #   signature: function(dat::Vector{<:Real}, design::PermuteDesign, specs::NamedTuple
    #   return:    ftype::Type{<:Float64},
    # process
    #   signature: function signature(dat::Matrix{<:Real}, design::PermuteDesign, specs::NamedTuple)
    #   return:    Matrix
...
function ClusterPermutationTestDefinition(;
    ...
    # check return type
    ArgsPreprocessFnc = (Matrix{<:Real}, PermuteDesign, NamedTuple)
    ArgsEstimFnc = (Vector{<:Real}, PermuteDesign, NamedTuple)
...
# helper
_nopreprocessing(data::Matrix{<:Real}, ::PermuteDesign, ::NamedTuple) = data
